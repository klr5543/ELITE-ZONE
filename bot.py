...
async def ask_ai_and_reply(message: discord.Message, question: str):
    ...
    if is_location_question or is_obtain_question:
        style_hint = (
            ...
            "أجب كأنك لاعب خبير يرد على صديقه في ديسكورد. "
            "استخدم قالب ثابت لا تتجاوزه: "
            "الجملة الأولى: اين يحصل اللاعب على الغرض (أهم منطقة أو منطقتين أو نوع صناديق واضح). "
            "الجملة الثانية: أفضل نصيحة عملية سريعة عن الطريقة أو الأسلوب أو التوقيت. "
            "الجملة الثالثة (اختيارية فقط): تحذير مهم عن ندرة الغرض أو خطورة المنطقة أو شيء يجب الانتباه له. "
            "لا تكتب مقدمات ولا تعيد صياغة السؤال ولا تضيف جمل خارج هذه الفكرة."
        )
    elif is_crafting_question:
        style_hint = (
            "هذا سؤال عن التصنيع. "
