    ...
    def item_embed(item: dict, translated_desc: str = None) -> discord.Embed:
        ...
        if intent == 'loot':
            ...
            if drops:
                ...
                text = f"بحسب خبرة اللاعبين ومصادر الإنترنت، غالبًا تحصل على {name} من مناطق اللوت الصناعية مثل Industrial أو من صناديق الميكانيك أو عند الأعداء في المناطق الصناعية. جرب أيضاً البحث في Dam Battlegrounds وThe Spaceport."
