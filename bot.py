...
async def ask_ai_and_reply(message: discord.Message, question: str):
    ...
    if is_location_question or is_obtain_question:
        style_hint = (
            ...
            "أجب كأنك لاعب خبير يرد على صديقه في ديسكورد، لكن بدون أي نصائح أو تحذيرات إضافية. "
            "استخدم قالب ثابت لا تتجاوزه بجملتين فقط: "
            "الجملة الأولى: اذكر اسم الغرض ثم أين يحصل عليه اللاعب غالباً، "
            "مع التركيز على أهم الخرائط أو الزونات أو أنواع الصناديق المحددة المتوفرة في النص "
            "مثل Scrapyard أو Checkpoint أو Warehouse أو أسماء مناطق مشابهة. "
            "الجملة الثانية: امثلة إضافية مختصرة على أماكن أخرى محتملة أو أنواع صناديق أخرى لنفس الغرض. "
            "لا تكتب أي نصيحة، ولا تحذير، ولا كلام عام عن الخطورة أو الندرة؛ فقط أماكن الظهور بشكل مباشر."
        )
    elif is_crafting_question:
        style_hint = (
            "هذا سؤال عن التصنيع. "
    ...
    ai_prompt = (
        ...
        "والتزم بألا تتجاوز إجابتك ثلاث جمل قصيرة متتالية، "
