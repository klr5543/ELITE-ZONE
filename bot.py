...
async def ask_ai_and_reply(message: discord.Message, question: str):
    ...
    if is_location_question or is_obtain_question:
        style_hint = (
            ...
            "ابدأ الجواب بجملة واضحة جداً من نوع: "
            "«أفضل مكان تركز عليه هو [اسم المنطقة أو الزون] لأن فيها كثافة صناديق تناسب هذا الغرض». "
            "بعدها اذكر مثال أو مثالين فقط لأهم الزونات أو الأماكن أو أنواع الصناديق التي يكثر فيها هذا الغرض "
            "مثل Checkpoint وWarehouse وScrap Yard إذا كانت مذكورة في النص. "
            "اختم الجواب بجملة نصيحة قصيرة عن التعامل مع خطورة المنطقة أو تجهيز العتاد. "
            "حافظ على الجواب كفقرة قصيرة من سطرين إلى ثلاثة بدون قوائم أو تعداد نقطي."
        )
    elif is_crafting_question:
        style_hint = (
